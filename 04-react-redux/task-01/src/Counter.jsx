...
//отправляем action значения в weather -они там изменяют state
//когда state в weather обновляются, то с помощью connect компоненты уведомляюься (новый стейти приходит в компоненту)
